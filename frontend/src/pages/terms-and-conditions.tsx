      ...
      <div className="bg-white">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-3 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the use of kollshs Website, located at https://kollsh.com/. By
                accessing this website we assume you accept these terms and
                conditions. Do not continue to use kollsh if you do not agree to
          ...
          <div className="mb-6 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                We employ the use of cookies. By accessing kollsh, you agreed to
                use cookies in agreement with the kollsh`s Privacy Policy. Most
                interactive websites use cookies to let us retrieve the user’s
                details for each visit. Cookies are used by our website to
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                Unless otherwise stated, kollsh and/or its licensors own the
                intellectual property rights for all material on kollsh. All
                intellectual property rights are reserved. You may access this
                from kollsh for your own personal use subjected to restrictions
                set in these terms and conditions.This Agreement shall begin on
                the date hereof. Our Terms and Conditions were created with the
              ...
              <p>
                ...
                website. kollsh does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of kollsh,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, kollsh shall not be liable for the
