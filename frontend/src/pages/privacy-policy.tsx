        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                At kollsh, accessible from kollsh dot com, one of our main
                priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and
                recorded by kollsh and how we use it. If you have additional
                questions or require more information about our Privacy Policy,
                do not hesitate to contact us.we may receive additional
              ...
              <p>
                ...
                information that they shared and/or collect in kollsh.we may
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                kollsh follows a standard procedure of using log files. These
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the advertising partners of kollsh. Third-party ad servers or ad
                networks uses technologies like cookies, JavaScript, or Web
                Beacons that are used in their respective advertisements and
                links that appear on kollsh, which are sent directly to users`
                ...
                Note that kollsh has no access to or control over these cookies
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                respective advertisements and links that appear on kollsh, which
                ...
                that you visit. Note that kollsh has no access to or control
                over these cookies that are used by third-party advertisers.
              </p>
              <p>
                kollsh`s Privacy Policy does not apply to other advertisers or
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              ...
              <p>
                kollsh does not knowingly collect any Personal Identifiable
